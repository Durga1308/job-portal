...
const Banner = ({query, handleInputChange}) => {
    ...
    return (
        <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14 ">
            ...
            <p className="text-lg text-black/70 mb-8">Thousands of jobs in the computer, engineering and technology sectors are waiting</p>
         <form>
            <div className="flex justify-start md:flex-row flex-col md:gap-0 gap-4">
                ...
                <div className="flex md:rounded-s-none rounded shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/3 w-full mx-7">
                ...
                <FiMapPin className="absolute mt-2.5 ml-2 text-gray-400"/>
                  ...
                  <button type='submit' className='py-2 px-8 bg-blue text-white mx-5'>Search</button>
            </div>
         </form>
        </div>
    )
